...
Route::prefix('/user')->middleware(['guest:web'])->group(function () {
  ...
  Route::post('/applicationFormSubmit', [UserController::class, 'applicationFormSubmit'])->middleware('language');
});
...
Route::prefix('/admin')->middleware(['auth:admin', 'lfm.path'])->group(function () {
  ...
  Route::group(['middleware' => 'checkpermission:Academic Sessions Management'], function ()
    {
  ...
  // buildings management route start
  Route::group(['middleware' => 'checkpermission:Rooms Management'], function () {
  ...
  // buildings management route end
  ...
  Route::group(['middleware' => 'checkpermission:Rooms Management'], function () {
    ...
    Route::post('/roomsManagement/update', [RoomsManagementController::class, 'update']);
